...
run_simulation;
plot_and_save(ans, "PID_standard_50deg",PID_param);

step_height = 120; %deg
enable_anti_windup = 0;
run_simulation;
plot_and_save(ans, "PID_standard_120deg",PID_param);

step_height = 50; %deg
enable_anti_windup = 1;
run_simulation;
plot_and_save(ans, "PID_anti_windup_50deg",PID_param);

step_height = 120; %deg
enable_anti_windup = 1;
run_simulation;
plot_and_save(ans, "PID_anti_windup_120deg",PID_param);
